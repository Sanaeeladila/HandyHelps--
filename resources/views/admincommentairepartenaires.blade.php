        ...
        <main>
            <div id="dashboard-section" class="section active">
                <div class="head-title">
                    <div class="left">
                        <h1 style=" font-size: 34px; text-align:center; margin-left: 290px;">Providers Comments</h1>
                    </div>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('confirm-delete-commentpartenaire', ['id' => $commentaire->id_commentaire]) }}">Supprimer</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
