...
<html>
    ...
    <body>
        <style>
            body{    margin: 0;    padding: 0;    background-color: #8cd0df; }
            ...
            h1{    text-align: center;    font-size: 45px;    color: #ffffff;    font-family: "Open Sans", serif; }
            ...
            .view-profile {    bottom: 10px;     background-color: #0097b2;    position: relative;    width: 100%;    margin-right: 20px;    margin-top: 70px;    color: #fff;    border: none;    padding: 10px 20px;    border-radius: 20px;    cursor: pointer; }
        ...
        <p>From <strong>pet sitting</strong> to <strong>dog walking</strong> and <strong>grooming</strong>, we provide comprehensive pet care services to keep your furry friends happy and healthy.</p>
        
        <div class="phrase">Our available partners</div>

        <div class="card-container">
            @foreach($petCarePartners as $user)
            <div class="card">
